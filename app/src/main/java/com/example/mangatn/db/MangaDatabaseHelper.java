...
public class MangaDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void recordChange(String action, String mangaId, int chapterReference, int progress, boolean completed, boolean inProgress) {
    ...
    public void recordChange(String action, String mangaId) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public void storeReadChapter(String mangaId, int chapterReference, int progress, boolean completed, boolean inProgress) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        ...
        recordChange(CREATE.getName(), mangaId, chapterReference, progress, completed, inProgress);
    ...
    public void deleteReadChapter(String mangaId, int chapterReference) {
        SQLiteDatabase db = getWritableDatabase();

        String whereClause = MANGA_ID_COLUMN_NAME + " = ? AND " + CHAPTER_REFERENCE_COLUMN_NAME + " = ?";
        String[] whereArgs = {mangaId, String.valueOf(chapterReference)};

        recordChange(DELETE.getName(), mangaId, chapterReference);
    ...
    public boolean checkIfReadChapterExists(String mangaId, int chapterReference) {
        SQLiteDatabase db = getReadableDatabase();

        String selection = MANGA_ID_COLUMN_NAME + " = ? AND " + CHAPTER_REFERENCE_COLUMN_NAME + " = ?";
        String[] columns = {MANGA_ID_COLUMN_NAME};
        String[] selectionArgs = {mangaId, String.valueOf(chapterReference)};
    ...
    public List<Integer> getReadChapters(String mangaId) {
        List<Integer> readChapters = new ArrayList<>();
        SQLiteDatabase db = getReadableDatabase();

        String[] columns = {CHAPTER_REFERENCE_COLUMN_NAME};
        String selection = MANGA_ID_COLUMN_NAME + " = ?";
        String[] selectionArgs = {mangaId};
        ...
        while (cursor.moveToNext()) {
            int chapterReference = cursor.getColumnIndex(CHAPTER_REFERENCE_COLUMN_NAME);

            readChapters.add(cursor.getInt(chapterReference));
        }
